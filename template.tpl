...

{
  ...
  "description": "Das Pageview Tracking übermittelt Informationen über den Seitentyp.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  {
    "type": "TEXT",
    "name": "inputVal",
    "displayName": "trbo Pagetype",
    "simpleValueType": true,
    "help": "Erstellen Sie eine neue Variable, die beispielsweise auf der \"trbo pageView Lookup Table\"-Variable Tempate aus der GTM Template Library basiert, und geben Sie den Namen hier ein",
    "valueValidators": [
      {
        "type": "NON_EMPTY"
      }
    ],
    "valueHint": "{{trbo pageType}}"
  }
]
...
const trbo_pageType = data.inputVal;

const trboqPush = createQueue('_trboq');
trboqPush(["page", {type: trbo_pageType}]);
